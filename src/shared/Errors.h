...
{ \
    ACE_Stack_Trace st; \
    sLog.outLog(LOG_DEFAULT, "%s:%i: Error: Assertion in %s failed: %s", \
        __FILE__, __LINE__, __FUNCTION__, STRINGIZE(CONDITION)); \
    sLog.outLog(LOG_DEFAULT, "%s", st.c_str()); \
...
{ \
    ACE_Stack_Trace st; \
    sLog.outLog(LOG_DEFAULT,  "%s:%i: Warning: Assertion in %s failed: %s",\
        __FILE__, __LINE__, __FUNCTION__, STRINGIZE(CONDITION)); \
    sLog.outLog(LOG_DEFAULT, "%s", st.c_str()); \
}
#else
